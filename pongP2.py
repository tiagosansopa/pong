...
while True:
	...
	m = "02,"+str(player2.mx)+","+str(player2.my)
	...
	if meteoro.mx == 40 and (meteoro.my +85 >= player2.my >= meteoro.my -85) :
		if meteoro.direction == "no":
			meteoro.direction = "ne"
			meteoro.my-=20
		elif meteoro.direction == "so":
			meteoro.direction = "se"
			meteoro.my+=20

	elif meteoro.mx == 40 and not (meteoro.my +85 >= player2.my >= meteoro.my-85) :
		player2.mx = 0
		player2.my = 2000
