...
while True:
	...
	if meteoro.my == 40 and (meteoro.mx +85 >= player3.mx >= meteoro.mx-85) :
		if meteoro.direction == "ne":
			meteoro.direction = "se"
			meteoro.mx+=20
		elif meteoro.direction == "no":
			meteoro.direction = "so"
			meteoro.mx-=20

	elif meteoro.my == 40 and not (meteoro.mx +618 >= player3.mx >= meteoro.mx) :
		player3.mx = 0
		player3.my = 2000
